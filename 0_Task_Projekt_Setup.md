...
**Vorgehen (15 min):**
- Legt ein neues privates Repository auf GitHub an. Der Name muss das Fahrzeug und die Autonummer enthalten (`autonom_car_<nummer>`).
...
- Füllt die **`0_car_checklist.md`** vollständig aus, zählt alle Teile nach und gebt sie **ausgedruckt und unterschrieben** ab.
...
- Liste der **Arbeitspakete** (z. B. "Montage der Sensoren", "Infrarot-Sensoren-Linearisierung", "Servo‑Scan‑Treiber", "Filterung", "Fehlerbehandlung und -korrektur").
...
- Skizziert einen **Zustandsautomaten** (z.B. Idle, Vorwärts, Rückwärts, Kurve links, Kurve rechts, Notstop).  
...
**Vorgehen (60 min):**
- Entwerft einen **7‑Wochen‑Plan** mit Meilensteinen (z.B. Chassis & Power einsatzbereit, Fahrzeug fährt gerade, Stabile Sensorwerte, autonome Navigation läuft, Parcours-Performance optimiert, Finales Rennen absolviert) und weist Verantwortliche zu.
